...
function loadMarketItems() {
    ...
    const pawnPrices = { 'glass_100': { name: 'Kính Lúp', price: 160, count: userData.glass_100 || 0, icon: '🔍' }, 'shield_100': { name: 'Bùa Bảo Hộ', price: 6400, count: Math.floor((userData.shield_100 || 0)/3), icon: '🛡️' }, 'time_100': { name: 'Đồng Hồ', price: 240, count: userData.time_100 || 0, icon: '⏳' }, 'torch_100': { name: 'Ngọn Đuốc', price: 200, count: userData.torch_100 || 0, icon: '🔥' } };
