...
function generateCode() {
    ...
    alert("Đúc mã thành công! Đã nâng cấp pháp bảo tự động phân biệt Tiếng Anh & Tiếng Trung và Bùa Bộ Gõ Pinyin!");
}
